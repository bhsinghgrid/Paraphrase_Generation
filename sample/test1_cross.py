...
#     with open("results1/test_metrics_NBaseC.json", "w") as f:
...
#         print(f"{k}: {v}")
#
#     print("\n✅ Results saved to results1/test_metrics.json")
#
# # =========================================================
# # MAIN
# # =========================================================
...
def run_test(test_size=5000):
    ...
    model_path = "/NBaseline/production_model4/best_d3pm_cross_attention.pt"
    ...
    os.makedirs("../results1", exist_ok=True)
    with open("results1/test_metrics_generative.json", "w") as f:
    ...
    print("\n✅ Results saved to results1/test_metrics_generative.json")
