...
class SanskritTrainer:
    ...
    def __init__(self, config=CONFIG):
        ...
        self._setup_logging()
        self.epoch_log_file = "results/training_results.json"
        self.epoch_results = []
    ...
    def compute_semantic_score(self):
        ...
        # Load once (you can also move this to __init__ if you want faster execution)
        ...
        # Encode sentences
        emb_preds = embed_model.encode(predictions, convert_to_tensor=True)
        emb_refs = embed_model.encode(references, convert_to_tensor=True)

        # Cosine similarity matrix
        sim_matrix = util.cos_sim(emb_preds, emb_refs)

        # Diagonal = correct pair similarity
        scores = sim_matrix.diag()
    ...
    def train(self):
        ...
        for epoch in range(self.cfg["training"]["epochs"]):
            ...
            bert_f1 = self.compute_semantic_score()
