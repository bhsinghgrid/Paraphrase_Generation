...
# =========================================================
CONFIG = {
    "model_type": "baseline_encoder_decoder",  # or baseline_cross_attention / baseline_encoder_decoder / d3pm_encoder_decoder
    "model": {
        "vocab_size": 16000,
        "max_seq_len": 80,
        "diffusion_steps": 12,
...
class SanskritTrainer:
    ...
    def create_datasets(self):
        ...
        full_dataset = OptimizedSanskritDataset(split="train", tokenizer=tokenizer, max_len=self.cfg["model"]["max_seq_len"],include_negative=True)
    ...
    #         return 0.0
    #
    #     results1 = self.bertscore.compute(predictions=predictions, references=references, lang="hi", batch_size=batch_size)
    #     return sum(results1["f1"]) / len(results1["f1"])
    ...
    #     results1 = bertscore_metric.compute(predictions=predictions, references=references, lang="hi")
    #     f1_score = float(np.mean(results1["f1"]))
    #
    #     return f1_score
    from bert_score import score
    ...
    def train(self):
        ...
        for epoch in range(self.cfg["training"]["epochs"]):
            ...
            if val_loss < best_val_loss:
                ...
                patience_counter = 0
                torch.save(self.model.state_dict(), f"production_model4/best_{self.cfg['model_type']}_neg.pt")
        ...
        with open("production_model4/training_metadata_neg.json", "w") as f:
