...
#     #     Minimal fix applied for SanskritTokenizer compatibility.
#     #     """
#     #     if not BERTSCORE_AVAILABLE:
#     #         return 0.0
#     #
...
#     #         return 0.0
#     #
#     #     # 🔹 Minimal fix: add required method dynamically
#     #     self.tokenizer.build_inputs_with_special_tokens = lambda x: x
#     #
#     #     # Compute BERTScore
#     #     P, R, F1 = score(predictions, references, lang="hi", verbose=False)
#     #     return F1.mean().item()
...
#         P, R, F1 = score(predictions, references, lang="hi", verbose=False)
#         return F1.mean().item()
#     # def compute_bertscore(self, max_samples=500, num_steps=6):
#     #     if not BERTSCORE_AVAILABLE:
#     #         return 0.0
#     #
#     #     self.model.eval()
...
#     #
#     #             # Faster diffusion (fewer steps)
#     #             if "d3pm" in self.cfg["model_type"]:
#     #                 generated = self.model.model.generate(input_ids, num_steps=num_steps)
#     #             else:
#     #                 generated = self.model.model.generate(input_ids)
#     #
#     #             # Decode each sequence properly
#     #             preds = [
...
#     #
#     #             predictions.extend(preds)
#     #             references.extend(refs[:len(preds)])  # align lengths
#     #
#     #     if not predictions:
#     #         return 0.0
#     #
#     #     # Batched BERTScore computation
#     #     batch_size = 64
#     #     f1_scores = []
#     #
...
#     #         f1_scores.append(f1)
#     #
#     #     return torch.cat(f1_scores).mean().item()
#
#     # -----------------------------------------------------
#     # MAIN TRAIN LOOP
#     # -----------------------------------------------------
...
#                 torch.save(
#                     self.model.state_dict(),
#                     f"production_model3/best2_{self.cfg['model_type']}.pt"
#                 )
#
#                 print("🎉 Best model saved.")
#             else:
...
#         import json
#         with open("production_model3/training_metadata.json", "w") as f:
